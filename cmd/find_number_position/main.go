...
import (
	...
	"github.com/mangelgz94/thinksurance-miguel-angel-gonzalez-morera/app/find_number_position_api"
...
func createApp() *cli.App {
	var config find_number_position_api.Config
	app := cli.NewApp()
	app.Version = "1.0"
	app.Flags = []cli.Flag{
		&cli.IntFlag{
	...
	app.Action = func(ctx *cli.Context) error {
		...
		grpcServer := find_number_position_api.New(&config)
		grpcServer.Start()
